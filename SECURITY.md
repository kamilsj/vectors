...
release notes before upgrading snapshot data.
...
access as trusted database access, use a long random token, protect snapshot
files with operating-system permissions, and do not expose the service directly
